...
ADDRESS_VERSIONS = {
    ...
    # Zcash transparent addresses use two-byte version prefixes:
    # 0x1CB8 -> "t1..." (P2PKH) and 0x1CBD -> "t3..." (P2SH).
    'zcash': {
        'p2pkh': 0x1CB8,
        'p2sh': 0x1CBD,
        'private': 0x80,
...
BIP44_COIN_TYPES = {
    ...
    # Additional Bitcoin-style networks.
    'namecoin': 7,
    'digibyte': 20,
    'monacoin': 22,
    'vertcoin': 28,
    ...
    # Additional EVM-compatible networks (all derive Ethereum-style addresses).
    'arbitrum': 60,
    'optimism': 60,
    'base': 60,
    'fantom': 1007,
