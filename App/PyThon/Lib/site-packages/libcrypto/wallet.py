...
COIN_CONFIG = {
    ...
    "fantom": {"uncompressed_required": True, "address_types": ["default"]},
    "cronos": {"uncompressed_required": True, "address_types": ["default"]},
    "gnosis": {"uncompressed_required": True, "address_types": ["default"]},
    "celo": {"uncompressed_required": True, "address_types": ["default"]},
    "moonbeam": {"uncompressed_required": True, "address_types": ["default"]},
    "moonriver": {"uncompressed_required": True, "address_types": ["default"]},
    "harmony": {"uncompressed_required": True, "address_types": ["default"]},
    "aurora": {"uncompressed_required": True, "address_types": ["default"]},
    "metis": {"uncompressed_required": True, "address_types": ["default"]},
    "kava": {"uncompressed_required": True, "address_types": ["default"]},
    "mantle": {"uncompressed_required": True, "address_types": ["default"]},
    "linea": {"uncompressed_required": True, "address_types": ["default"]},
    "scroll": {"uncompressed_required": True, "address_types": ["default"]},
    "blast": {"uncompressed_required": True, "address_types": ["default"]},
    "opbnb": {"uncompressed_required": True, "address_types": ["default"]},
    "zksync": {"uncompressed_required": True, "address_types": ["default"]},
    "polygon_zkevm": {"uncompressed_required": True, "address_types": ["default"]},
    "sonic": {"uncompressed_required": True, "address_types": ["default"]},
    ...
    "ravencoin": {"uncompressed_required": False, "address_types": ["p2pkh"]},
    "zcash": {"uncompressed_required": False, "address_types": ["p2pkh"]},
    "testnet": {
        "uncompressed_required": False,
        "address_types": ["p2pkh", "p2sh-p2wpkh", "p2wpkh", "p2tr"],
    },
...
class Wallet:
    ...
    def get_address(self, coin: str, address_type: str = "p2pkh") -> str:
        ...
        if address_type == "default":
            addr_type = "default"
        elif address_type == "p2pkh" and "default" in types and "p2pkh" not in types:
